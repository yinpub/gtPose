...
StereoNode::~StereoNode () {
    ...
    if(save_trajectoryTum_param_) {
        orb_slam_->SaveKeyFrameTrajectoryTUM("/home/host/zhongxiangrong/orb_slam_2_ros/StereoKeyFrameTrajectoryTum.txt");
        orb_slam_->SaveTrajectoryTUM("/home/host/zhongxiangrong/orb_slam_2_ros/StereoTrajectoryTum.txt");
        orb_slam_->SaveTrajectoryKITTI("/home/host/zhongxiangrong/orb_slam_2_ros/StereoSaveTrajectoryKITTI.txt");
    }
    delete left_sub_;
    delete right_sub_;
    delete sync_;
